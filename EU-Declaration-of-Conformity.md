...
**Product:** DeepL Write
**Reference:** DoC-deepl_write-2.1.0

## 1. Product identification

- **Product name:** DeepL Write
...
- **Distribution channels:** TYPO3 Extension Repository (TER) — https://extensions.typo3.org/extension/deepl_write; Packagist — https://packagist.org/packages/web-vision/deepl-write
...
DeepL Write, version 2.1.0, as distributed via the TYPO3 Extension
...
> https://security.web-vision.de/conformity/web-vision/deepl-write/2.1.0/en/
